...
(function () {
  ...
  function buildHtml(ctx) {
    ...
    var escalaItem = isAdmin
      ? "<a href=\"/escala-spa.html\" class=\"dropdown-item\" style=\"text-decoration:none;display:block\">Escala Mensal (Turnos)</a>"
      : "<a href=\"/escala-spa.html\" class=\"dropdown-item sh-active\">Escala Mensal (Turnos)</a>";
      ...
      "<div class=\"header-actions\">" +
        ...
        "<div class=\"admin-dropdown\" id=\"spa-dropdown\">" +
          ...
          "<div class=\"admin-dropdown-menu\" id=\"spa-dropdown-menu\">" +
            ...
            item("btn-open-escala", "Escala de Trabalho") +
            escalaItem +
          "</div>" +
        "</div>" +
