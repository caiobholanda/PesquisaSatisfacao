...
(function () {
  ...
  var CSS = [
    ...
    ".header-brand small { font-family: var(--font, 'Inter', 'DM Sans', system-ui, sans-serif); font-size: 0.75rem; letter-spacing: .1em; text-transform: uppercase; color: var(--muted); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; max-width: 260px; }",
